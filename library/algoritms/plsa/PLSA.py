...
class PLSA:
    ...
    def __init__(self, corpus):
        ...
        self._doc_topic = 'C:\\Users\\miga\\Desktop\\data-lws\\library\\examples\\LW3\\results\\doc-topic.txt'
        self._topic_word = 'C:\\Users\\miga\\Desktop\\data-lws\\library\\examples\\LW3\\results\\topic-word.txt'
        self._dic = 'C:\\Users\\miga\\Desktop\\data-lws\\library\\examples\\LW3\\results\\dic.dic'
        self._topics = 'C:\\Users\\miga\\Desktop\\data-lws\\library\\examples\\LW3\\results\\topics.txt'
        ...
        for document in corpus.get_documents():
            normalized_list = Normalizer.to_normal_form(Normalizer
                                                        .document_to_list(document))
            self._segList = Normalizer.remove_stop_words(self._stopWords.get_stop_words(),
                                                         normalized_list)
            self._wordCount = {}
    ...
    def init_stop_words(self):
        self._stopWords.load_stop_words()
